...
TEST_CASE("Testing predators") {
  ...
  SUBCASE("Testing fid_prey method") {
   ...
   SUBCASE("Testing update method") {
    ...
    CHECK(updated_predators[1].get_vel().get_x() == doctest::Approx(5.4f).epsilon(0.1));
    CHECK(updated_predators[1].get_vel().get_y() == doctest::Approx(-0.6f).epsilon(0.1));
    CHECK(updated_predators[1].get_pos().get_x() == doctest::Approx(2.7f).epsilon(0.1));
    CHECK(updated_predators[1].get_pos().get_y() == doctest::Approx(4.7f).epsilon(0.01));
  }
}
