...
TEST_CASE("Testing no close boids") {
  ...
  SUBCASE("Testing update method") {
    ...
    CHECK(updated_boids[0].get_vel().get_x() ==
          doctest::Approx(2.f).epsilon(0.001));
    CHECK(updated_boids[0].get_vel().get_y() ==
    ...
    CHECK(updated_boids[1].get_pos().get_x() ==
          doctest::Approx(4.5f).epsilon(0.001));
    CHECK(updated_boids[1].get_pos().get_y() ==
          doctest::Approx(4.2f).epsilon(0.001));

    CHECK(updated_boids[2].get_vel().get_x() ==
          doctest::Approx(4.f).epsilon(0.001));
    CHECK(updated_boids[2].get_vel().get_y() ==
          doctest::Approx(-3.f).epsilon(0.001));
    CHECK(updated_boids[2].get_pos().get_x() ==
          doctest::Approx(3.5f).epsilon(0.001));
    CHECK(updated_boids[2].get_pos().get_y() ==
          doctest::Approx(5.5f).epsilon(0.001));
  }
}
...
TEST_CASE("Testing one close boids") {
  ...
  SUBCASE("Testing find methods") {
    CHECK(flock.find_separation(b3).get_x() ==
          doctest::Approx(-0.2f).epsilon(0.1));
    CHECK(flock.find_separation(b3).get_y() ==
          doctest::Approx(0.f).epsilon(0.1));

    CHECK(flock.find_alignment(b3).get_x() ==
          doctest::Approx(-0.8f).epsilon(0.1));
    CHECK(flock.find_alignment(b3).get_y() ==
          doctest::Approx(0.2f).epsilon(0.1));

    CHECK(flock.find_cohesion(b3).get_x() ==
          doctest::Approx(0.6f).epsilon(0.1));
    CHECK(flock.find_cohesion(b3).get_y() ==
          doctest::Approx(-0.3f).epsilon(0.1));
  ...
  SUBCASE("Testing update method") {
    ...
    CHECK(updated_boids[3].get_vel().get_x() ==
          doctest::Approx(4.6f).epsilon(0.1));
    CHECK(updated_boids[3].get_vel().get_y() ==
          doctest::Approx(0.1f).epsilon(0.1));
    CHECK(updated_boids[3].get_pos().get_x() ==
          doctest::Approx(2.3f).epsilon(0.1));
    CHECK(updated_boids[3].get_pos().get_y() ==
          doctest::Approx(3.05f).epsilon(0.01));
  }
}
